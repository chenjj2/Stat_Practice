...
'''
prestep: straight_ic.py
same setup, but vary 
1. random seed
2. (temperature, stepscale)
'''
...
hyper_prob0 = np.loadtxt('lin1/t1_s2_hyper_best.out')
hyper_stepsize = (stepsize*stepscale) * np.ones(3*n_pop)
local_prob0 = np.loadtxt('lin1/t1_s2_local_prob_best.out')
...
### save
np.savetxt(lindir+'/t'+str(int(temperature))+'_s'+str(int(stepscale))+'_pid'+str(pid)+'_hyper_prob.out',hyper_prob_chain[:stop_step,:])
np.savetxt(lindir+'/t'+str(int(temperature))+'_s'+str(int(stepscale))+'_pid'+str(pid)+'_hyper.out',hyper_chain[:stop_step,:])
np.savetxt(lindir+'/t'+str(int(temperature))+'_s'+str(int(stepscale))+'_pid'+str(pid)+'_loglike.out',loglike_chain[:stop_step])
np.savetxt(lindir+'/t'+str(int(temperature))+'_s'+str(int(stepscale))+'_pid'+str(pid)+'_repeat.out',repeat_chain[:stop_step])

### save best
best_ind = np.argmax(loglike_chain)
np.savetxt(lindir+'/t'+str(int(temperature))+'_s'+str(int(stepscale))+'_pid'+str(pid)+'_hyper_prob_best.out',hyper_prob_chain[best_ind,:])
np.savetxt(lindir+'/t'+str(int(temperature))+'_s'+str(int(stepscale))+'_pid'+str(pid)+'_local_prob_best.out',local_prob_chain[best_ind,:])
np.savetxt(lindir+'/t'+str(int(temperature))+'_s'+str(int(stepscale))+'_pid'+str(pid)+'_local_best.out',local_chain[best_ind,:])
